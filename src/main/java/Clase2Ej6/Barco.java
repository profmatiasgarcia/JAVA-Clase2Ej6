...
public class Barco extends Vehiculos {
    ...
    public Barco(String medioLocomocion, int capacidadPersonas, String utilizacionGeneral) {
        super(medioLocomocion, capacidadPersonas, utilizacionGeneral);
    }

    public Barco(String medioLocomocion, int capacidadPersonas, String utilizacionGeneral, String motor,
