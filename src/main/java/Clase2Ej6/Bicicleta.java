...
public class Bicicleta extends Vehiculos {
    ...
    public Bicicleta(String medioLocomocion, int capacidadPersonas, String utilizacionGeneral) {
        super(medioLocomocion, capacidadPersonas, utilizacionGeneral);
    }

    public Bicicleta(String medioLocomocion, int capacidadPersonas, String utilizacionGeneral, String motor,
