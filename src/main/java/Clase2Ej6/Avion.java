...
public class Avion extends Vehiculos {
    ...
    public Avion(String medioLocomocion, int capacidadPersonas, String utilizacionGeneral) {
        super(medioLocomocion, capacidadPersonas, utilizacionGeneral);
    }

    public Avion(String medioLocomocion, int capacidadPersonas, String utilizacionGeneral, String motor, int litrosCombustible) {
        super(medioLocomocion, capacidadPersonas, utilizacionGeneral);
        this.Motor = motor;
